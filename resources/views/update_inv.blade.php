...
<div class="backbg container-fluid">
	<div class="row">
		...
		<div class="col-md-6 register">
			<h3>Invoice</h3>
			<form method="post" action="{{route('saveUpdateInv')}}">
				{{csrf_field()}}
				<input type="hidden" name="inv_no" id="inv_no" value="{{$post->inv_no}}">
				...
				<div class="form-group">
			  	...
			  	<div class="form-group">
			    	...
			    	<input type="text" class="form-control" id="amt" name="amt" value="{{$post->amount}}">
			  	</div>
