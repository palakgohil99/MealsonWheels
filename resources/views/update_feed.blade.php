...
<div class="backbg container-fluid">
	<div class="row">
		...
		<div class="col-md-6 register">
			<h3>Feedback</h3>
			<form method="post" action="{{route('saveUpdateFeed')}}">
				{{csrf_field()}}
				<input type="hidden" name="feed_id" value="{{$post->feed_id}}">
				...
				<div class="form-group">
			    	...
			    	<textarea name="cmt" class="form-control" id="cmt" rows="4">{{$post->comment}}</textarea>
			  	</div>
			  	<div class="form-group">
